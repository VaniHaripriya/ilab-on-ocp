...
func retrievePipelineId(t *testing.T, pipelineServerURL, pipelineDisplayName string, bearerToken string) (string, error) {
	client := &http.Client{}
...
// verifyPipelineSuccess polls the pipeline run status until it succeeds or times out
func verifyPipelineSuccess(t *testing.T, pipelineServerURL, runID string, bearerToken string) error {
	client := &http.Client{}
